...
export interface IVirtualListProps extends IReactComponentProps {
	...
	striped?: boolean;
	/** manually set wrapper fontSize in pixels (note: this will be overridden if disableResizeObserver is 'false', but should be used if 'disableResizeObserver' is set to 'true') */
